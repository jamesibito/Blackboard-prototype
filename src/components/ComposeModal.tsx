...
export default function ComposeModal({ onClose }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal */}
      <div className="relative w-full max-w-[560px] bg-white dark:bg-[#1A2236] rounded-2xl border border-gray-200 dark:border-[#2D3A52] shadow-2xl overflow-hidden mx-4">
        {/* Header */}
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 dark:border-[#232d42]">
          <h2 className="text-[16px] font-bold text-gray-900 dark:text-gray-100">New Message</h2>
          <button
            onClick={onClose}
        ...
        <div className="p-6 space-y-4">
          {/* To field */}
          <div>
            <label className="block text-[11px] font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wide mb-1.5">
              To
            </label>
            <input
              type="text"
        ...
        <div className="flex items-center justify-between px-6 py-4 border-t border-gray-100 dark:border-[#232d42] bg-gray-50/50 dark:bg-[#131825]/50">
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={onClose}
              className="px-4 py-2 rounded-xl text-[13px] font-medium text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-[#232d42] transition"
            >
              Cancel
            </button>
            <button
