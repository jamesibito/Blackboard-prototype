...
export const tools: ToolItem[] = [
  ...
  // ── Campus Services ──
  {
    ...
    description: 'Book group study rooms at St. James, Casa Loma, and Waterfront.',
    details: 'Rooms seat up to 6 people (one room accommodates 8). Each room includes a large LCD monitor (42–60") — some with multi-touch displays — plus a whiteboard. Book online up to 7 days in advance; same-day rooms are mobile-only. Rooms fill fast during exam season — book early.',
    category: 'campus', status: 'active', color: '#0EA5E9',
    url: 'https://www.georgebrown.ca/library-learning-commons/services/book-a-study-room',
  },
  {
    id: 'print-centre', name: 'GBC Print Centre', abbr: 'PRT',
    description: 'Print, copy, scan, bind, and large-format poster printing.',
    details: 'Xerox Print Centres at St. James (Bldg A, Room 114) and Casa Loma (Bldg C, Room C210). Hours: Mon–Thu 7:45 AM–5:00 PM, Fri 7:45 AM–4:30 PM. Submit jobs remotely via PaperCut to skip the queue. Wide-format poster printing and 3D printing also available. Foam-core mounting on request — useful for portfolio crit days.',
    category: 'campus', status: 'active', color: '#6366F1',
    url: 'https://www.georgebrown.ca/library-learning-commons/services/printing-copying',
    linkedCourses: ['2D', 'VD', 'IA', 'TD'],
  },
  {
    id: 'tech-lab', name: 'Tech Lab Rentals', abbr: 'TLR',
    description: 'Borrow laptops, tablets, VR headsets, hotspots, and AV gear.',
    details: 'Free to borrow with your student ID (your library card). Most items loan for 7 days, renewable if there\'s no waitlist. Laptops and AV equipment are 8-hour on-campus loans. Available: laptops, iPads, Wi-Fi hotspots, Meta Quest VR headsets, cameras, lavalier mics, and ring lights. Complete a one-time Loan Agreement form on your first visit.',
    category: 'campus', status: 'active', color: '#8B5CF6',
    url: 'https://www.georgebrown.ca/library-learning-commons/services/borrow-equipment',
